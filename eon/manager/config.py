...
class Configuration(object):
    def __init__(self, args):
        ...
        self.args = args
        self.dist_dir = self._get("installation", "dist_dir", "/opt/eon")

        self.config = configparser.ConfigParser(interpolation=configparser.ExtendedInterpolation())
        self.config.read(["eon.conf",
                          "etc/eon.conf",
                          os.path.join(self.dist_dir, "etc", "eon.conf")])
        ...
        self.set_default(de, "eond", os.path.join(self.dist_dir, "sbin", "eond"))
        self.set_default(de, "log_file", os.path.join(self.dist_dir, "var", "log", "eond.log"))
        ...
        self.set_default(il, "install_path", "/opt/eon")
